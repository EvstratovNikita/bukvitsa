...
// Состояние моста с площадкой. Из настроек убрано, но объект остаётся: это
// единственный способ увидеть, на каком шаге встала синхронизация, если игрок
// снова сообщит о потере прогресса. Ничего не рисует, читается из консоли
// (window.__buklitsaCloud) — отладочная сборка для этого не нужна.
...
// Для разбора проблем без пересборки: window.__buklitsaCloud в консоли.
if (typeof window !== 'undefined') window.__buklitsaCloud = cloudStatus;
