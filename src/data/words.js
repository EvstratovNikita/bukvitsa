...
export const WORDS = [
  ...
  'замок', 'диван', 'лента', 'ветка', 'время', 'голос', 'рамка', 'мышка',
  'сумка', 'чашка', 'ложка', 'вилка', 'молот', 'волна', 'трава', 'букет',
  'слово', 'место', 'дождь', 'ветер', 'облик', 'образ', 'народ', 'город',
  'метро', 'театр', 'отель', 'музей', 'сквер', 'ручей', 'озеро', 'песок',
  'скала', 'туман', 'метла', 'венок', 'жираф', 'зебра', 'сокол', 'ворон',
  ...
  'крупа', 'пшено', 'манка', 'батон', 'пирог', 'кефир', 'масло', 'какао',
  'отвар', 'кость', 'жилет', 'вальс', 'танго', 'опера', 'фильм', 'актер',
  'певец', 'наука', 'фокус', 'свеча', 'пешка', 'ладья', 'ферзь', 'кубик',
