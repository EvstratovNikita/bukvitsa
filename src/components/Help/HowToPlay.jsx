  ...
  return (
    <div className="help-cat">
      ...
      <Topic icon="🔤" title="Режимы 4 и 6 букв">
        ...
        возвращают +1 энергию в основном режиме (до 3 в день).
      </Topic>
      <Topic icon="🏆" title="Достижения">
        За успехи в игре — серии, быстрые победы, число слов — положены
        монеты.{isEmbedded
          ? ' Забери награду кнопкой «Забрать» в разделе «Достижения» — число на значке показывает, сколько наград ждёт.'
          : ' Они начисляются сразу.'}
      </Topic>
    </div>
  );
}
  ...
  return (
    <div className="help-cat">
      ...
      <Topic icon="👛" title="Где взять монеты">
        Победы, достижения, наряды Букли и ежедневный вход.{isVk
          ? ' Магазин — в главном меню (кнопка с домиком справа вверху) или по «+» у монет.'
          : ' Магазин — в меню справа вверху.'}
      </Topic>
    </div>
  );
}
