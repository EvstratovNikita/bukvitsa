...
const STEPS = [
  ...
  },
  {
    ...
    text: 'Дополнительные режимы — без траты энергии. Каждые 5 побед в них возвращают +1 энергию.'
  },
  ...
  isVk
    ? {
        sel: '[data-tour="menu"]',
        title: 'Главное меню',
        text: 'Магазин, питомец, достижения, рейтинг, статистика, друзья и настройки. Вернуться сюда можно в любой момент — кнопкой с домиком.'
      }
    : {
        sel: '[data-tour="menu"]',
        title: 'Меню',
