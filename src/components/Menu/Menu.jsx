    ...
    <>
      ...
      >
        ...
        <nav className="menu__list">
          ...
          {/* Таблица лидеров есть на обеих площадках: у Яндекса данные даёт
              его API, у VK — наш сервер. Если сервер не настроен, пункт не
              показываем — пустое окно хуже отсутствующего пункта. */}
          {hasLeaderboard && (
