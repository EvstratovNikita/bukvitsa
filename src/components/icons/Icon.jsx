...
// Звезда — «Достижения». Кубок (TrophyIcon) занят лидербордом, и два
// одинаковых значка подряд читались как одна и та же кнопка. Медаль с
// ленточками на 20px превращалась в кляксу с усиками, поэтому звезда: на
// такой сетке она единственная читается с первого взгляда.
export function AwardIcon(props) {
  return (
    <svg {...base} {...props} aria-hidden="true">
      <path d="M12 4.5 L14.12 9.59 L19.61 10.03 L15.42 13.61 L16.7 18.97 L12 16.1 L7.3 18.97 L8.58 13.61 L4.39 10.03 L9.88 9.59 Z" />
    </svg>
  );
}
